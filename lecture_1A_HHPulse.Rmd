...
There is a bit of weirdness in the left, where it looks like there are suddenly a bunch of people who were born in 1933 but nobody in 1932 or earlier. This is due to a coding choice by the Census, where really old people are labeled as born in "1933" (top-coding) but it actually should be interpreted as meaning "in 1933 or before". So if you were to get finicky (and every good statistician is!) you might go back to the calculations of averages previously and modify them all. For instance, to select just those who are female and who are coded as having age less than 90. Many variables are topcoded! *And recall that topcoding wouldn't change the median values calculated before, which is a point in favor of that statistic.*
